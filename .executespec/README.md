# `.executespec/` — for `navneetprabhakar/tictactoe`

> Generated by ExecuteSpec on `2026-07-17T02:07:47.184903Z`.
...
└── config/
    └── brownfield-acceptance-2026-07-17/
...
| `config/brownfield-acceptance-2026-07-17/*.yaml` | no | Customer-authored config; ExecuteSpec only proposes additions |
...
`config/brownfield-acceptance-2026-07-17/standards.yaml`,
