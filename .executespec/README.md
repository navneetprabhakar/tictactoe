...
> Generated by ExecuteSpec on `2026-07-17T05:32:34.981786Z`.
...
| `config/rca-live-acceptance-20260717/*.yaml` | no | Customer-authored config; ExecuteSpec only proposes additions |
...
`config/rca-live-acceptance-20260717/standards.yaml`,
