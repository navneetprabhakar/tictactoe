...
> Generated by ExecuteSpec on `2026-05-22T15:47:19.087371Z`.
...
| `config/surface-test-tictactoe/*.yaml` | no | Customer-authored config; ExecuteSpec only proposes additions |
...
`config/surface-test-tictactoe/standards.yaml`,
