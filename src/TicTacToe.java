...
public class TicTacToe {
     ...
     * @param game GameConfig object containing the board state
     * @return String representing the winning mark ('X' or 'O'), or null if no horizontal winner
     */
     ...
     * @param game GameConfig object containing the board state
     * @return String representing the winning mark ('X' or 'O'), or null if no vertical winner
     */
     ...
     * @param game GameConfig object containing the board state
     * @return String representing the winning mark ('X' or 'O'), or null if no diagonal winner
     */
